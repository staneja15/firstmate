...
Child-directory invocations resolve the owning Git root, preserve already-owned-lock silence, and refuse unrelated nested repositories or directories outside Git.
