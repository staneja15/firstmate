...
FM_STALE_ESCALATE_SECS=240         # idle seconds before a provably-working stale pane escalates, and before a park on an already-delivered captain-relevant status escalates once; stale panes whose crew is neither provably working nor parked surface immediately
