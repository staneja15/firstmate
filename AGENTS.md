...
config/afk-refuse  optional standing away-mode refusal; LOCAL, gitignored, not inherited; present and non-blank refuses every away-mode entry and prints its non-blank lines as the reason, bounded at 20 lines with an explicit truncation marker beyond that; see docs/configuration.md "Standing away-mode refusal"
