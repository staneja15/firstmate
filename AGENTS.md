...
config/afk-refuse  optional standing away-mode refusal; LOCAL, gitignored, not inherited; present and non-blank refuses every away-mode entry and prints its contents as the reason; see docs/configuration.md "Standing away-mode refusal"
